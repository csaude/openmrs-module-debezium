...
public class DebeziumConstants {
	...
	public final static String GP_TABLES_TO_INCLUDE = MODULE_ID + ".table.include.list";
	
	public final static String GP_TABLES_TO_EXCLUDE = MODULE_ID + ".table.exclude.list";
	
	public final static String GP_HISTORY_FILE = MODULE_ID + ".history.file";
	...
	public final static String GP_SNAPSHOT_LOCK_MODE = MODULE_ID + ".snapshot.locking.mode";
	
	public final static String GP_SSL_MODE = MODULE_ID + ".database.ssl.mode";
